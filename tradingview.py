...
class tradingview:
    ...
    def __init__(self):
        ...
        session_entry = db.search(Session.key == 'sessionid')
        self.sessionid = session_entry[0]['value'] if session_entry else 'abcd'
        ...
        if test.status_code != 200:
            ...
            # Save the new sessionid in TinyDB
            db.upsert({'key': 'sessionid', 'value': self.sessionid},
